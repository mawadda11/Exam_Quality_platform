...
function reference(
  ...
  return {
    ...
    association_candidates: candidates.map((candidate, index) => ({
      ...
      basis: candidate.exact ? 'exact_label' : 'proximity_support',
      confidence: candidate.exact ? 0.94 : 0.5,
...
const REFERENCES = [
  ...
  reference(7, 'المخطط أدناه', 'figure:unlabeled', 'unresolved', [
    { materialId: 'diagram', exact: false },
  ]),
